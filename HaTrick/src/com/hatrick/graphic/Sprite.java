...
public abstract class Sprite {
	...
	public void draw(){
		...
		if(_acting){
			...
			_currentAnimation.draw((int)(Stage.getCamera().get_Camera_x()-current_frame.getCenterOfRotationX()*_scale),(int)(Stage.getCamera().get_Camera_y()-current_frame.getCenterOfRotationY()*_scale), current_frame.getWidth()*_scale, current_frame.getHeight()*_scale);
			...
			_currentImg.draw((int)(Stage.getCamera().get_Camera_x()-_currentImg.getCenterOfRotationX()*_scale),(int)(Stage.getCamera().get_Camera_y()-_currentImg.getCenterOfRotationY()*_scale), _currentImg.getWidth()*_scale, _currentImg.getHeight()*_scale);
		}
	}
